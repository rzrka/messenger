...
class ClientDatabase:
    class KnownUsers(BASE):
        ...
        def __repr__(self):
            return f'<known_users({self.id}, {self.username})>'
    ...
    class MessageStat(BASE):
        ...
        def __repr__(self):
            return f'<MessageHistory({self.id}, {self.contact}, {self.direction}, {self.message}, {self.date})>'
    ...
    class Contacts(BASE):
        ...
        def __repr__(self):
            return f'<Contacts({self.id}, {self.name})>'
