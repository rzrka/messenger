...
class ServerStorage:
    ...
    class AllUsers(BASE):
        ...
        def __repr__(self):
            return f'<AllUsers({self.id}, {self.name}, {self.last_login}, {self.passwd_hash}, {self.pubkey})>'
    ...
    class ActiveUsers(BASE):
        ...
        def __repr__(self):
            return f'<ActiveUsers({self.id}, {self.user}, {self.ip}, {self.port}, {self.login_time})>'
    ...
    class LoginHistory(BASE):
        ...
        def __repr__(self):
            return f'<LoginHistory({self.id}, {self.name}, {self.ip}, {self.port}, {self.date_time})>'
    ...
    class UsersContacts(BASE):
        ...
        def __repr__(self):
            return f'<UsersContacts({self.id}, {self.user}, {self.contact})>'
    ...
    class UsersHistory(BASE):
        ...
        def __repr__(self):
            return f'<UsersHistory({self.id}, {self.user}, {self.sent}, {self.accepted})>'
